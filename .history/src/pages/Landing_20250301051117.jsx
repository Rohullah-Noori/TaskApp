...
function Landing() {
  ...
  return (
    <>
      <Navbar />
      <div className="flex bg-blue-100 max-h-screen  justify-items-center  sm:h-screen justify-center">
        <div className=" text-center mt-15 px-10 sm:px-20 md:px-30 lg:px-40  ">
