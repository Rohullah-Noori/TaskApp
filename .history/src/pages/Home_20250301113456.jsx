...
function Home() {
  ...
  return (
    <div>
      ...
      <div className="taskContainer">
        <div className="mt-10 text-center h-[90%]  shadow-lg bg-amber-50  rounded-xl p-10 max-w-screen sm:w-150  md:w-200 mb-10">
          <h1 className="heading">Task List</h1>
          {loading && <Loader />}
          <div className="justify-center flex md:flex-wrap">
            <ul className="flex md:flex-row md:space-x-3 md:flex-wrap">
              {tasks && tasks.length > 0 ? (
                tasks.map((task) => (
                  <li key={task.id}>
                    <input
